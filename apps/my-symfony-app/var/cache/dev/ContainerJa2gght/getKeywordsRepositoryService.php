...
// Returns the private 'App\Repository\KeywordsRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/KeywordsRepository.php';

return $this->privates['App\\Repository\\KeywordsRepository'] = new \App\Repository\KeywordsRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
