...
{% block panel %}
    ...
    {% endif %}
{% endblock %}
", "@Security/Collector/security.html.twig", "/root/docker/pingouin-du-web/apps/my-symfony-app/vendor/symfony/security-bundle/Resources/views/Collector/security.html.twig");
    }
}
