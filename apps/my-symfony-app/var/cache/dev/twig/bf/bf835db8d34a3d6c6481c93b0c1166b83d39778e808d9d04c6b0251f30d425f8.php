...
class __TwigTemplate_9ef2a1f3b15ed2e975b9626b51ef234b90c9d09973a390e92118616ae46e5601 extends \Twig\Template
{
    private $source;
    private $macros = [];
    ...
    public function block_body($context, array $blocks = [])
    {
        ...
        // line 5
        echo "    <h1>Page not fhjtjtjuyjkyyyuyuiound</h1>
...
{% block body %}
    <h1>Page not fhjtjtjuyjkyyyuyuiound</h1>

    <p>
        The requested page couldn't be located. Checkout for any URL
        misspelling or <a href=\"{{ path('homepage') }}\">return to the homepage</a>.
    </p>
{% endblock %}", "@Twig/Exception/error.html.twig", "/root/docker/pingouin-du-web/apps/my-symfony-app/templates/bundles/TwigBundle/Exception/error.html.twig");
    }
}
