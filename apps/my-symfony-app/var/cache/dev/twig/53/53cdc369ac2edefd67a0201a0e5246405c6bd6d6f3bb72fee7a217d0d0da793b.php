...
{% block panel %}
    ...
    {% endif %}
{% endblock %}
", "@WebProfiler/Collector/cache.html.twig", "/root/docker/pingouin-du-web/apps/my-symfony-app/vendor/symfony/web-profiler-bundle/Resources/views/Collector/cache.html.twig");
    }
}
