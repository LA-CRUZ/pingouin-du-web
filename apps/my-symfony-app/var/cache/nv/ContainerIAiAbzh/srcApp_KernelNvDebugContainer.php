 ...
 */
class srcApp_KernelNvDebugContainer extends Container
{
    ...
    private function getDynamicParameter($name)
    {
        switch ($name) {
            ...
            case 'debug.container.dump': $value = ($this->targetDirs[0].'/srcApp_KernelNvDebugContainer.xml'); break;
    ...
    protected function getDefaultParameters()
    {
        return [
            ...
            'kernel.container_class' => 'srcApp_KernelNvDebugContainer',
            ...
            'router.cache_class_prefix' => 'srcApp_KernelNvDebugContainer',
